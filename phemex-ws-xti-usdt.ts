...
/**
 * Phemex WebSocket XTIUSDT Price — subscribes to the XTIUSDT 24h ticker and
 * tick channels, printing the last price to stdout on each update.
 *
